...
func (wf *WatchFactory) Start() error {
	...
	if config.OVNKubernetesFeature.EnableEgressIP && wf.eiptFactory != nil {
...
func (wf *WatchFactory) GetEgressIPTraffic(name string) (*egressiptrafficapi.EgressIPTraffic, error) {
	egressIPTrafficLister := wf.informers[EgressIPTrafficType].lister.(egressiptrafficlister.EgressIPTrafficLister)
